...
int main() {
    ...
    printf("Cargo Manifest number %d, temperature: %0.2fºC, materials: %s.\n", ptr_manifests->containerID, ptr_manifests->containerTemperature, ptr_manifests->materials);
...
void read_file() {
    ...
    */
    ...
    exit(1);
        ...
        char line[101]; //size da struct + "\0"
